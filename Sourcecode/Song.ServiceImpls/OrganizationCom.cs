...
namespace Song.ServiceImpls
{
    public class OrganizationCom : IOrganization
    {
        ...
        public void UpdateStatisticalData()
        {
            ...
            {
                //统计机构的课程数
                int org_count = Business.Do<IQuestions>().Total(org.Org_ID, -1, -1, -1, 0, -1, null, false);
        ...
        private static void _update_Subject_StatisticalData_task(Subject subject)
        {
            ...
            {
                //试题数，试卷数，课程数
                int ques_count = Business.Do<IQuestions>().Total(-1, subject.Sbj_ID, -1, -1, 0, -1, null, false);
